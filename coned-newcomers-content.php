        ...
        <section id="intro">
         ...
         <section id="way-find">
            <section id="way-find-item">
                ...
                <ul class="list-2">
                    <li><a href="#">Canadian Securities<br /><span class="code">this is the small text</span></a></li>
                    <li><a href="#">Financial Planning<br /><span class="code">this is the small text</span></a></li>
