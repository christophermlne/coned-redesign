					...
					<form>
						<nav class="toggle-nav">
							<ul class="black-white">
								<li>
									<a class="av-gallery first-child selected" rel="IN-CLASS">In Class</a>
								</li>
								<li>
									<a class="av-gallery last-child" rel="ONLINE">Online</a>
								</li>
							</ul>
						</nav>
						...
						<section id="nav-filter">
							<fieldset id="filter" style="display: block;">
